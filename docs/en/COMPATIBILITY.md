...
- The working target for every package here is **97%+, individually** — not a corpus-wide average.
  ...
  `Ardalis.GuardClauses` 97.5%, `FluentValidation` 98.1%); the rest are active hardening targets,
