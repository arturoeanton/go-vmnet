...
| `FluentValidation@11.9.2` | 97.0% (1,289 methods, 39 flagged) | High coverage estimate; unverified by a real run. |
...
| `CsvHelper@33.1.0` | 91.8% (1,393 methods, 114 flagged) | Good coverage estimate; unverified by a real run. |
| `MediatR@14.2.0` | 93.0% (441 methods, 31 flagged) | Moderate coverage estimate; unverified by a real run. |
| `AutoMapper@16.2.0` | 88.3% (2,319 methods, 271 flagged) | Its own heavy `System.Linq.Expressions`/`Expression.Compile()`-based mapping-plan generation is a real, likely source of the remaining gap — treat this number as more optimistic than the others in this table until a real demo exercises it. |
