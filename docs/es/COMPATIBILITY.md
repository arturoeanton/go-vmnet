...
- El objetivo de trabajo para cada paquete acá es **97%+, individualmente** — no un promedio de
  ...
  98.1%); el resto son objetivos activos de endurecimiento, priorizados por cuánto están por
