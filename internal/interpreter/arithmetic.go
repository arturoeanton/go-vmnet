...
func evalBinOp(op ir.BinOpKind, a, b runtime.Value) (runtime.Value, error) {
	if a.Kind != b.Kind {
		return runtime.Value{}, fmt.Errorf("interpreter: binary op on mismatched value kinds (%d, %d)", a.Kind, b.Kind)
	}
	switch a.Kind {
	case runtime.KindI4:
		return evalBinOpInt(op, a.I4, b.I4, runtime.Int32)
	case runtime.KindI8:
		return evalBinOpInt(op, a.I8, b.I8, runtime.Int64)
	case runtime.KindR4:
		return evalBinOpFloat(op, a.R4, b.R4, runtime.Float32)
	case runtime.KindR8:
		return evalBinOpFloat(op, a.R8, b.R8, runtime.Float64)
	default:
...
func evalCompare(op ir.CompareOp, a, b runtime.Value) (bool, error) {
	if a.Kind != b.Kind {
		return false, fmt.Errorf("interpreter: compare on mismatched value kinds (%d, %d)", a.Kind, b.Kind)
	}
	switch a.Kind {
	case runtime.KindI4:
		return compareOrdered(op, a.I4, b.I4), nil
	case runtime.KindI8:
		return compareOrdered(op, a.I8, b.I8), nil
	case runtime.KindR4:
		return compareOrdered(op, a.R4, b.R4), nil
	case runtime.KindR8:
		return compareOrdered(op, a.R8, b.R8), nil
	default:
		return false, fmt.Errorf("interpreter: compare on unsupported value kind %d", a.Kind)
	}
}

func compareOrdered[T int32 | int64 | float32 | float64](op ir.CompareOp, a, b T) bool {
	switch op {
	case ir.CmpEq:
		return a == b
	case ir.CmpNe:
